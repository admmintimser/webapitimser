...
const appointmentSchema = new mongoose.Schema({
    ...
    areaType: {
        type: String,
        required: true,
        enum: ['Urbana', 'Rural', 'Prefiero no contestar'],
    },
    educationLevel: {
        type: String,
        required: true,
        enum: ['Educación básica', 'Educación media', 'Educación media superior', 'Educación superior', 'Postgrado', 'No tengo estudios', 'Prefiero no contestar'],
    },
    sampleLocation: {
        type: String,
        required: true,
